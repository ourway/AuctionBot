        ...
        for x in range(1, len(row)):
            if row[x]:
                ...
                if i < 12:                  # keeping the range intact for the csv file
                    ...
                    candidates[i] += 1 # increase this candidates points
        # if candidates[1]>1735:
            # print str(exampleReader.line_num)
...
print "Winner by Approval Voting is candidate #" + str(index) + " with " + str(candidates[index]) + " points!!"
print candidates
